...
if __name__ == "main":
    format_conllu_dataset("./datasets/unformatted/multiNERD/test_en.tsv", save=True)
    #format_xml_dataset("./datasets/unformatted/meddocan/test",save=True)
    #format_xml_merged_dataset("./dataset/unformatted/n2c2",save=True)
