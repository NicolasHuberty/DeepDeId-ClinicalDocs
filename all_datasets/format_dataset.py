...
if __name__ == "__main__":
    ...
    #format_n2c2_dataset("./datasets/unformatted/n2c2",save=True)
    #format_brat_dataset("./datasets/unformatted/QUAERO_FrenchMed/test",save=True)
    input_file_path = 'datasets/formatted/multiNERD/train_en.tsv'
    output_file_path = 'datasets/formatted/multiNERD/train_enMap.tsv'
